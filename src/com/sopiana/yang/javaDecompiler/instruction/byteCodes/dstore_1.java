...
{
	public static final opcodeTable ins = opcodeTable._dstore_1;
	
	public static dstore_1 getInstance(byte[]codes, int offset) throws instructionException
	{
		if(codes[offset]!=ins.opcode)
			throw new instructionException("supplied code is not valid "+ins.mnemonic+" opcode");
		dstore_1 res = new dstore_1();
		res.offset = offset;
