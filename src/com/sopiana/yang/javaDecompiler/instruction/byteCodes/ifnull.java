...
{
	public static final opcodeTable ins = opcodeTable._ifnull;
	private short branch;
	public static ifnull getInstance(byte[]codes, int offset) throws instructionException
	{
		if(codes[offset]!=ins.opcode)
			throw new instructionException("supplied code is not valid "+ins.mnemonic+" opcode");
		ifnull res = new ifnull();
		res.offset = offset;
