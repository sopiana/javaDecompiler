...
{
	public static final opcodeTable ins = opcodeTable._iconst_0;
	
	public static iconst_0 getInstance(byte[]codes, int offset) throws instructionException
	{
		if(codes[offset]!=ins.opcode)
			throw new instructionException("supplied code is not valid "+ins.mnemonic+" opcode");
		iconst_0 res = new iconst_0();
		res.offset = offset;
