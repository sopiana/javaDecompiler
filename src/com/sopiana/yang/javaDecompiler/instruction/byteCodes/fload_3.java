...
{
	public static final opcodeTable ins = opcodeTable._fload_3;
	
	public static fload_3 getInstance(byte[]codes, int offset) throws instructionException
	{
		if(codes[offset]!=ins.opcode)
			throw new instructionException("supplied code is not valid "+ins.mnemonic+" opcode");
		fload_3 res = new fload_3();
		res.offset = offset;
