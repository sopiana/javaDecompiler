...
{
	public static final opcodeTable ins = opcodeTable._dstore_2;
	
	public static dstore_2 getInstance(byte[]codes, int offset) throws instructionException
	{
		if(codes[offset]!=ins.opcode)
			throw new instructionException("supplied code is not valid "+ins.mnemonic+" opcode");
		dstore_2 res = new dstore_2();
		res.offset = offset;
