...
{
	public static final opcodeTable ins = opcodeTable._dup2_x2;
	
	public static dup2_x2 getInstance(byte[]codes, int offset) throws instructionException
	{
		if(codes[offset]!=ins.opcode)
			throw new instructionException("supplied code is not valid "+ins.mnemonic+" opcode");
		dup2_x2 res = new dup2_x2();
		res.offset = offset;
