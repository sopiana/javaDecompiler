...
{
	public static final opcodeTable ins = opcodeTable._freturn;
	
	public static freturn getInstance(byte[]codes, int offset) throws instructionException
	{
		if(codes[offset]!=ins.opcode)
			throw new instructionException("supplied code is not valid "+ins.mnemonic+" opcode");
		freturn res = new freturn();
		res.offset = offset;
