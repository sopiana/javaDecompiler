...
{
	public static final opcodeTable ins = opcodeTable._dstore_3;
	
	public static dstore_3 getInstance(byte[]codes, int offset) throws instructionException
	{
		if(codes[offset]!=ins.opcode)
			throw new instructionException("supplied code is not valid "+ins.mnemonic+" opcode");
		dstore_3 res = new dstore_3();
		res.offset = offset;
