...
{
	public static final opcodeTable ins = opcodeTable._lload_3;
	
	public static lload_3 getInstance(byte[]codes, int offset) throws instructionException
	{
		if(codes[offset]!=ins.opcode)
			throw new instructionException("supplied code is not valid "+ins.mnemonic+" opcode");
		lload_3 res = new lload_3();
		res.offset = offset;
