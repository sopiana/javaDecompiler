...
{
	public static final opcodeTable ins = opcodeTable._istore;
	private byte index;
	public static istore getInstance(byte[]codes, int offset) throws instructionException
	{
		if(codes[offset]!=ins.opcode)
			throw new instructionException("supplied code is not valid "+ins.mnemonic+" opcode");
		istore res = new istore();
		res.offset = offset;
