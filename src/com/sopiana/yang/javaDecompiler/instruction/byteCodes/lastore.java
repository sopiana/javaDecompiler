...
{
	public static final opcodeTable ins = opcodeTable._lastore;
	
	public static lastore getInstance(byte[]codes, int offset) throws instructionException
	{
		if(codes[offset]!=ins.opcode)
			throw new instructionException("supplied code is not valid "+ins.mnemonic+" opcode");
		lastore res = new lastore();
		res.offset = offset;
