...
{
	public static final opcodeTable ins = opcodeTable._fconst_1;
	
	public static fconst_1 getInstance(byte[]codes, int offset) throws instructionException
	{
		if(codes[offset]!=ins.opcode)
			throw new instructionException("supplied code is not valid "+ins.mnemonic+" opcode");
		fconst_1 res = new fconst_1();
		res.offset = offset;
