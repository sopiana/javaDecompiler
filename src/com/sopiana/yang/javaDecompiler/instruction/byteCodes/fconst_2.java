...
{
	public static final opcodeTable ins = opcodeTable._fconst_2;
	
	public static fconst_2 getInstance(byte[]codes, int offset) throws instructionException
	{
		if(codes[offset]!=ins.opcode)
			throw new instructionException("supplied code is not valid "+ins.mnemonic+" opcode");
		fconst_2 res = new fconst_2();
		res.offset = offset;
