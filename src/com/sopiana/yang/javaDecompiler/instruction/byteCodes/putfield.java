...
{
	public static final opcodeTable ins = opcodeTable._putfield;
	private short index;
	public static putfield getInstance(byte[]codes, int offset) throws instructionException
	{
		if(codes[offset]!=ins.opcode)
			throw new instructionException("supplied code is not valid "+ins.mnemonic+" opcode");
		putfield res = new putfield();
		res.offset = offset;
