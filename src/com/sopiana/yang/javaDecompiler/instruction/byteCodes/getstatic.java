...
{
	public static final opcodeTable ins = opcodeTable._getstatic;
	private short index;
	public static getstatic getInstance(byte[]codes, int offset) throws instructionException
	{
		if(codes[offset]!=ins.opcode)
			throw new instructionException("supplied code is not valid "+ins.mnemonic+" opcode");
		getstatic res = new getstatic();
		res.offset = offset;
