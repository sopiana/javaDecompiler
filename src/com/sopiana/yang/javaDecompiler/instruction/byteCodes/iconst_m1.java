...
{
	public static final opcodeTable ins = opcodeTable._iconst_m1;
	
	public static iconst_m1 getInstance(byte[]codes, int offset) throws instructionException
	{
		if(codes[offset]!=ins.opcode)
			throw new instructionException("supplied code is not valid "+ins.mnemonic+" opcode");
		iconst_m1 res = new iconst_m1();
		res.offset = offset;
