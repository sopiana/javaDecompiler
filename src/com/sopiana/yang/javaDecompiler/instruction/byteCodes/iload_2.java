...
{
	public static final opcodeTable ins = opcodeTable._iload_2;
	
	public static iload_2 getInstance(byte[]codes, int offset) throws instructionException
	{
		if(codes[offset]!=ins.opcode)
			throw new instructionException("supplied code is not valid "+ins.mnemonic+" opcode");
		iload_2 res = new iload_2();
		res.offset = offset;
