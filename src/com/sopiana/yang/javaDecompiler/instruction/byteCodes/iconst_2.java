...
{
	public static final opcodeTable ins = opcodeTable._iconst_2;
	
	public static iconst_2 getInstance(byte[]codes, int offset) throws instructionException
	{
		if(codes[offset]!=ins.opcode)
			throw new instructionException("supplied code is not valid "+ins.mnemonic+" opcode");
		iconst_2 res = new iconst_2();
		res.offset = offset;
