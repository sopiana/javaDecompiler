...
{
	public static final opcodeTable ins = opcodeTable._sastore;
	
	public static sastore getInstance(byte[]codes, int offset) throws instructionException
	{
		if(codes[offset]!=ins.opcode)
			throw new instructionException("supplied code is not valid "+ins.mnemonic+" opcode");
		sastore res = new sastore();
		res.offset = offset;
