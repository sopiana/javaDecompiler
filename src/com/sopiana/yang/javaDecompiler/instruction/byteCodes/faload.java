...
{
	public static final opcodeTable ins = opcodeTable._faload;
	
	public static faload getInstance(byte[]codes, int offset) throws instructionException
	{
		if(codes[offset]!=ins.opcode)
			throw new instructionException("supplied code is not valid "+ins.mnemonic+" opcode");
		faload res = new faload();
		res.offset = offset;
