...
{
	public static final opcodeTable ins = opcodeTable._lconst_1;
	
	public static lconst_1 getInstance(byte[]codes, int offset) throws instructionException
	{
		if(codes[offset]!=ins.opcode)
			throw new instructionException("supplied code is not valid "+ins.mnemonic+" opcode");
		lconst_1 res = new lconst_1();
		res.offset = offset;
