...
{
	public static final opcodeTable ins = opcodeTable._iconst_3;
	
	public static iconst_3 getInstance(byte[]codes, int offset) throws instructionException
	{
		if(codes[offset]!=ins.opcode)
			throw new instructionException("supplied code is not valid "+ins.mnemonic+" opcode");
		iconst_3 res = new iconst_3();
		res.offset = offset;
