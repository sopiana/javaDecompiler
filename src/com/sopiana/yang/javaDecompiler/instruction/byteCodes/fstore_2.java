...
{
	public static final opcodeTable ins = opcodeTable._fstore_2;
	
	public static fstore_2 getInstance(byte[]codes, int offset) throws instructionException
	{
		if(codes[offset]!=ins.opcode)
			throw new instructionException("supplied code is not valid "+ins.mnemonic+" opcode");
		fstore_2 res = new fstore_2();
		res.offset = offset;
