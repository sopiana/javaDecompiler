...
{
	public static final opcodeTable ins = opcodeTable._iconst_4;
	
	public static iconst_4 getInstance(byte[]codes, int offset) throws instructionException
	{
		if(codes[offset]!=ins.opcode)
			throw new instructionException("supplied code is not valid "+ins.mnemonic+" opcode");
		iconst_4 res = new iconst_4();
		res.offset = offset;
