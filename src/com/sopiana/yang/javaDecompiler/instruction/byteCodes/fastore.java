...
{
	public static final opcodeTable ins = opcodeTable._fastore;
	
	public static fastore getInstance(byte[]codes, int offset) throws instructionException
	{
		if(codes[offset]!=ins.opcode)
			throw new instructionException("supplied code is not valid "+ins.mnemonic+" opcode");
		fastore res = new fastore();
		res.offset = offset;
