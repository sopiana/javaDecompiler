...
{
	public static final opcodeTable ins = opcodeTable._lstore_1;
	
	public static lstore_1 getInstance(byte[]codes, int offset) throws instructionException
	{
		if(codes[offset]!=ins.opcode)
			throw new instructionException("supplied code is not valid "+ins.mnemonic+" opcode");
		lstore_1 res = new lstore_1();
		res.offset = offset;
