...
{
	public static final opcodeTable ins = opcodeTable._fload_0;
	
	public static fload_0 getInstance(byte[]codes, int offset) throws instructionException
	{
		if(codes[offset]!=ins.opcode)
			throw new instructionException("supplied code is not valid "+ins.mnemonic+" opcode");
		fload_0 res = new fload_0();
		res.offset = offset;
