...
{
	public static final opcodeTable ins = opcodeTable._lload_2;
	
	public static lload_2 getInstance(byte[]codes, int offset) throws instructionException
	{
		if(codes[offset]!=ins.opcode)
			throw new instructionException("supplied code is not valid "+ins.mnemonic+" opcode");
		lload_2 res = new lload_2();
		res.offset = offset;
