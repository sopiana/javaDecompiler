...
{
	public static final opcodeTable ins = opcodeTable._iastore;
	
	public static iastore getInstance(byte[]codes, int offset) throws instructionException
	{
		if(codes[offset]!=ins.opcode)
			throw new instructionException("supplied code is not valid "+ins.mnemonic+" opcode");
		iastore res = new iastore();
		res.offset = offset;
