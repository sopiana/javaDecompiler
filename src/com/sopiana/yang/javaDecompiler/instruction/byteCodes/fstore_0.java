...
{
	public static final opcodeTable ins = opcodeTable._fstore_0;
	
	public static fstore_0 getInstance(byte[]codes, int offset) throws instructionException
	{
		if(codes[offset]!=ins.opcode)
			throw new instructionException("supplied code is not valid "+ins.mnemonic+" opcode");
		fstore_0 res = new fstore_0();
		res.offset = offset;
