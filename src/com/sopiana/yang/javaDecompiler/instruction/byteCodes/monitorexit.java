...
{
	public static final opcodeTable ins = opcodeTable._monitorexit;
	
	public static monitorexit getInstance(byte[]codes, int offset) throws instructionException
	{
		if(codes[offset]!=ins.opcode)
			throw new instructionException("supplied code is not valid "+ins.mnemonic+" opcode");
		monitorexit res = new monitorexit();
		res.offset = offset;
