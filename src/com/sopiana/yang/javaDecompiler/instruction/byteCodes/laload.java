...
{
	public static final opcodeTable ins = opcodeTable._laload;
	
	public static laload getInstance(byte[]codes, int offset) throws instructionException
	{
		if(codes[offset]!=ins.opcode)
			throw new instructionException("supplied code is not valid "+ins.mnemonic+" opcode");
		laload res = new laload();
		res.offset = offset;
