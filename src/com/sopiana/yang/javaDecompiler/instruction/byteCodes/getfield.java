...
{
	public static final opcodeTable ins = opcodeTable._getfield;
	private short index;
	public static getfield getInstance(byte[]codes, int offset) throws instructionException
	{
		if(codes[offset]!=ins.opcode)
			throw new instructionException("supplied code is not valid "+ins.mnemonic+" opcode");
		getfield res = new getfield();
		res.offset = offset;
