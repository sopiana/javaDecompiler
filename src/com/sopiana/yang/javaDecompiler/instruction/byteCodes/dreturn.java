...
{
	public static final opcodeTable ins = opcodeTable._dreturn;
	
	public static dreturn getInstance(byte[]codes, int offset) throws instructionException
	{
		if(codes[offset]!=ins.opcode)
			throw new instructionException("supplied code is not valid "+ins.mnemonic+" opcode");
		dreturn res = new dreturn();
		res.offset = offset;
