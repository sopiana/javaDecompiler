...
{
	public static final opcodeTable ins = opcodeTable._lstore_2;
	
	public static lstore_2 getInstance(byte[]codes, int offset) throws instructionException
	{
		if(codes[offset]!=ins.opcode)
			throw new instructionException("supplied code is not valid "+ins.mnemonic+" opcode");
		lstore_2 res = new lstore_2();
		res.offset = offset;
