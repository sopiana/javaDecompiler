...
{
	public static final opcodeTable ins = opcodeTable._lstore_3;
	
	public static lstore_3 getInstance(byte[]codes, int offset) throws instructionException
	{
		if(codes[offset]!=ins.opcode)
			throw new instructionException("supplied code is not valid "+ins.mnemonic+" opcode");
		lstore_3 res = new lstore_3();
		res.offset = offset;
