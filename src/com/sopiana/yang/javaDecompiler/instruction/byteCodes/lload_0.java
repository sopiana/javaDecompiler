...
{
	public static final opcodeTable ins = opcodeTable._lload_0;
	
	public static lload_0 getInstance(byte[]codes, int offset) throws instructionException
	{
		if(codes[offset]!=ins.opcode)
			throw new instructionException("supplied code is not valid "+ins.mnemonic+" opcode");
		lload_0 res = new lload_0();
		res.offset = offset;
