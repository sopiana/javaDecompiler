...
{
	public static final opcodeTable ins = opcodeTable._istore_0;
	
	public static istore_0 getInstance(byte[]codes, int offset) throws instructionException
	{
		if(codes[offset]!=ins.opcode)
			throw new instructionException("supplied code is not valid "+ins.mnemonic+" opcode");
		istore_0 res = new istore_0();
		res.offset = offset;
