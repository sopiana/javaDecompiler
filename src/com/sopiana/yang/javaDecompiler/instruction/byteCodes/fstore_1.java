...
{
	public static final opcodeTable ins = opcodeTable._fstore_1;
	
	public static fstore_1 getInstance(byte[]codes, int offset) throws instructionException
	{
		if(codes[offset]!=ins.opcode)
			throw new instructionException("supplied code is not valid "+ins.mnemonic+" opcode");
		fstore_1 res = new fstore_1();
		res.offset = offset;
