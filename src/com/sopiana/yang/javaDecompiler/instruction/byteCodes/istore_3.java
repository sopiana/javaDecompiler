...
{
	public static final opcodeTable ins = opcodeTable._istore_3;
	
	public static istore_3 getInstance(byte[]codes, int offset) throws instructionException
	{
		if(codes[offset]!=ins.opcode)
			throw new instructionException("supplied code is not valid "+ins.mnemonic+" opcode");
		istore_3 res = new istore_3();
		res.offset = offset;
