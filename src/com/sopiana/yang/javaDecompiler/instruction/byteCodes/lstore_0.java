...
{
	public static final opcodeTable ins = opcodeTable._lstore_0;
	
	public static lstore_0 getInstance(byte[]codes, int offset) throws instructionException
	{
		if(codes[offset]!=ins.opcode)
			throw new instructionException("supplied code is not valid "+ins.mnemonic+" opcode");
		lstore_0 res = new lstore_0();
		res.offset = offset;
