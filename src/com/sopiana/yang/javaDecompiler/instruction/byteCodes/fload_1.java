...
{
	public static final opcodeTable ins = opcodeTable._fload_1;
	
	public static fload_1 getInstance(byte[]codes, int offset) throws instructionException
	{
		if(codes[offset]!=ins.opcode)
			throw new instructionException("supplied code is not valid "+ins.mnemonic+" opcode");
		fload_1 res = new fload_1();
		res.offset = offset;
