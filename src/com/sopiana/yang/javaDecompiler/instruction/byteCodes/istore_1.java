...
{
	public static final opcodeTable ins = opcodeTable._istore_1;
	
	public static istore_1 getInstance(byte[]codes, int offset) throws instructionException
	{
		if(codes[offset]!=ins.opcode)
			throw new instructionException("supplied code is not valid "+ins.mnemonic+" opcode");
		istore_1 res = new istore_1();
		res.offset = offset;
