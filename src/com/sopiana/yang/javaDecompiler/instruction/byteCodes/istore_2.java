...
{
	public static final opcodeTable ins = opcodeTable._istore_2;
	
	public static istore_2 getInstance(byte[]codes, int offset) throws instructionException
	{
		if(codes[offset]!=ins.opcode)
			throw new instructionException("supplied code is not valid "+ins.mnemonic+" opcode");
		istore_2 res = new istore_2();
		res.offset = offset;
