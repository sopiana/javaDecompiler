...
{
	public static final opcodeTable ins = opcodeTable._dup_x2;
	
	public static dup_x2 getInstance(byte[]codes, int offset) throws instructionException
	{
		if(codes[offset]!=ins.opcode)
			throw new instructionException("supplied code is not valid "+ins.mnemonic+" opcode");
		dup_x2 res = new dup_x2();
		res.offset = offset;
