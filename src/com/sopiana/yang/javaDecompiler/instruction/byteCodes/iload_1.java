...
{
	public static final opcodeTable ins = opcodeTable._iload_1;
	
	public static iload_1 getInstance(byte[]codes, int offset) throws instructionException
	{
		if(codes[offset]!=ins.opcode)
			throw new instructionException("supplied code is not valid "+ins.mnemonic+" opcode");
		iload_1 res = new iload_1();
		res.offset = offset;
