...
{
	public static final opcodeTable ins = opcodeTable._putstatic;
	private short index;
	public static putstatic getInstance(byte[]codes, int offset) throws instructionException
	{
		if(codes[offset]!=ins.opcode)
			throw new instructionException("supplied code is not valid "+ins.mnemonic+" opcode");
		putstatic res = new putstatic();
		res.offset = offset;
