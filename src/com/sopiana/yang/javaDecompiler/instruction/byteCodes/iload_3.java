...
{
	public static final opcodeTable ins = opcodeTable._iload_3;
	
	public static iload_3 getInstance(byte[]codes, int offset) throws instructionException
	{
		if(codes[offset]!=ins.opcode)
			throw new instructionException("supplied code is not valid "+ins.mnemonic+" opcode");
		iload_3 res = new iload_3();
		res.offset = offset;
