 ...
 * 
 * <p>The <code>CONSTANT_Fieldref_info</code> represent description of a field in a class:</p>
...
public class CONSTANT_Fieldref_info extends cp_info{
	 ...
	 * <p>The class_index item of a <code>CONSTANT_Fieldref_info</code> structure may be either a class type or an interface type.</p>
	 */
	...
	/**
	 * Factory method to generate a <code>CONSTANT_Fieldref_info</code> instance from given array of byte in specific offset.
	 * 
	 * <p>Each <code>CONSTANT_Fieldref_info</code> should begin with 1 byte of <code>tag</code> describing type of <code>constant_pool</code> entry, 
	 ...
	 * @throws decompilerException decompilerException if supplied <code>classFileData</code> has invalid <code>CONSTANT_Fieldref_info</code> tag
	 */
	public static CONSTANT_Fieldref_info getInstance(byte[] classFileData, int offset) throws decompilerException
    {
		CONSTANT_Fieldref_info res = new CONSTANT_Fieldref_info();
		if(classFileData[offset]!=cp_info.CONSTANT_Fieldref)
